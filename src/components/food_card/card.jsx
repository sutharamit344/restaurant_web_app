...
const vegIndianDishes = [
  {
    id: 1,
    image: "assets/vegie/palak_paneer.png",
    name: "Palak Paneer",
  ...
  {
    id: 2,
    image: "assets/vegie/chole-bhature.png",
    name: "Chole Bhature",
  ...
  {
    id: 3,
    image: "assets/vegie/malai-kofta.png",
    name: "Malai Kofta",
  ...
  {
    id: 4,
    image: "assets/vegie/masala-dosa.png",
    name: "Masala Dosa",
  ...
  {
    id: 5,
    image: "assets/vegie/aloo-gobi.png",
    name: "Aloo Gobi",
  ...
  {
    id: 6,
    image: "assets/vegie/baingan-bharta.png",
    name: "Baingan Bharta",
  ...
  {
    id: 7,
    image: "assets/vegie/dal-tadka.png",
    name: "Dal Tadka",
  ...
  {
    id: 8,
    image: "assets/vegie/bhindi-masala.png",
    name: "Bhindi Masala",
  ...
  {
    id: 9,
    image: "assets/vegie/veg-biryani.png",
    name: "Veg Biryani",
  ...
  {
    id: 10,
    image: "assets/vegie/matar-paneer.png",
    name: "Matar Paneer",
...
export default function Card(props) {
  ...
  return (
    ...
    <div className='card-img'>
      <img src={domain+vegie.image} alt={vegie.name} />
